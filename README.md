...
- git remote add hw7.2 https://github.com/Rick-77-2024/ReactHW/
- git push --set-upstream ррhw7.2 ReactHW/hw7.2

FE. ДЗ 7

1. Відтворити і запам’ятати процедуру використання useCallback, useMemo, memo. Описати кожен рядок, що і навіщо робити

2. cf69cHp

Створити кастомний  хук,  який буде повертати відповіді з апі і заміняти useState+ useEffect.  ендпоінт апі –   аргумент вашого хука. 
